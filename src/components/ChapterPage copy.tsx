      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="mb-6 relative">
          <img 
            ...
            className="w-full max-w-2xl mx-auto rounded-lg comic-border" 
            onError={(e) => {
          ...
          <div 
            ...
            style={{ display: chapter === 0 && page === 1 ? 'none' : 'block' }}
          />
          <div 
            className="absolute top-0 right-0 w-1/2 h-full cursor-pointer" 
            onClick={goToNextPage}
            style={{ display: chapter === Object.keys(chapterContent).length - 1 && page === currentChapter.pageCount ? 'none' : 'block' }}
          />
        </div>
